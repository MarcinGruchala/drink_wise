...
Use Android-specific tooling for performance work:

| Tool | Use For |
|------|---------|
| Layout Inspector | Recomposition counts and layout inspection |
| Macrobenchmark | Startup, scrolling, and frame timing |
| Baseline Profiles | Startup and critical user-flow warmup |
| Android Studio Profiler | CPU, memory, allocations, and jank investigation |
| R8/ProGuard | Release optimization and shrinking |
